...
export default function OurServiceSecound() {
  return (
    <section className="p-[0_0_100px] relative max-[991px]:p-[0_0_60px] max-[480px]:p-[0_0_40px]">
      <div className="container">
        <div className="text-center mb-[50px] max-[991px]:mb-[30px]">
          ...
          <h2 className="text-[#181059]">how to create images to video</h2>
        </div>
        <div className="bg-[#EFE9FF] p-[48px] rounded-[55px]">
          <div className="relative bg-[#4D2F8C] rounded-[55px] p-[1px_3px] max-[767px]:rounded-[30px] mb-[40px]">
